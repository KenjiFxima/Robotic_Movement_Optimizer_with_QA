...
def dynamic_programming(task_start, task_end, velocity):
    """
    Implementation of Simple DP, an algorithm that solves the Traveling
...
if __name__ == '__main__':
    ...
    print('')
    start = time.time()
    print(dynamic_programming(task_start, task_end, velocity))
